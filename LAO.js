...
<head>
    <script type="text/javascript">
        ...
        // The callback functions of resolve state by the then method,The callback functions of resolve state by the catch method
        ...
        else if ((c == '+' || c == '-') && data.indexOf("+") == -1 && data.indexOf("-") == -1) {
        data += c;
        i++;
        continue;
    }
